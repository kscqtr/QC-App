...
import 'tubular_weight_page.dart';
import 'dumbbell_weight_page.dart';

class HotSetWeightSelectionPage extends StatefulWidget {
  const HotSetWeightSelectionPage({super.key});

  @override
  State<HotSetWeightSelectionPage> createState() => _HotSetWeightSelectionPageState();
}

class _HotSetWeightSelectionPageState extends State<HotSetWeightSelectionPage> {
  ...
  final List<Map<String, dynamic>> _carouselItemsData = [
    {
      ...
      'pageBuilder': () => const TubularWeightPage(),
    },
    {
      'title': 'Dumbbell',
