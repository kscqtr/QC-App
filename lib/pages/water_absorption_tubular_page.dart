...
class WaterAbsorptionTubularPage extends StatefulWidget {
  const WaterAbsorptionTubularPage({super.key});

  @override
  WaterAbsorptionTubularPageState createState() => WaterAbsorptionTubularPageState();
}

class WaterAbsorptionTubularPageState extends State<WaterAbsorptionTubularPage> {
 ...
 void _scrollToBottom() {
  ...
  void _performCalculations() {
    ...
    for (int i = 0; i < _sampleControllers.length; i++) {
      ...
      if (diameterText.isEmpty && m1Text.isEmpty && m2Text.isEmpty && m3Text.isEmpty) { // MODIFIED: removed length check
         if (_sampleControllers.length > 1) {
      ...
      else if (diameter <= 0) {errorMsg = 'Diameter must be positive (Sample ${i+1}).';}
      ...
      // New formula for Surface Area
      double surfaceArea = (pi * diameter! * length) / 100;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // --- MODIFIED: Removed Length input field ---
                Row(
                  children: [
                    Expanded(child: _buildTextField(label: 'Diameter (mm)', controller: controllers.diameterController)),
                  ],
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Water Absorption - Tubular')),
      body: Padding(
