...
import 'loss_of_mass_dumbbell_page.dart';
import 'loss_of_mass_tubular_page.dart';

class LossOfMassPage extends StatefulWidget {
  const LossOfMassPage({super.key});

  @override
  State<LossOfMassPage> createState() => _LossOfMassPageState();
}

class _LossOfMassPageState extends State<LossOfMassPage> {
  ...
  final List<Map<String, dynamic>> _carouselItemsData = [
    {
      'title': 'Dumbbell',
      'imagePath': 'images/',
      'pageBuilder': () => const LossOfMassDumbbellPage(),
    },
    {
      'title': 'Tubular',
      'imagePath': 'images/',
      'pageBuilder': () => const LossOfMassTubularPage(),
    },
  ];
