...
import 'hot_set_weight_selection_page.dart';
import 'dumbbell_calculation_page.dart';

class HotSetPage extends StatefulWidget {
  const HotSetPage({super.key});

  @override
  State<HotSetPage> createState() => _HotSetPageState();
}

class _HotSetPageState extends State<HotSetPage> {
  ...
  final List<Map<String, dynamic>> _carouselItemsData = [
    {
      'title': 'Calculation',
      'imagePath': 'images/dumbbell_calculation.png',
      'pageBuilder': () => const DumbbellCalculationPage(),
    },
    {
      'title': 'Weight',
      'imagePath': 'images/dumbbell_weight.png',
      'pageBuilder': () => const HotSetWeightSelectionPage(),
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        // --- Corrected AppBar Title for Hot Set ---
        title: const Text(
          'Hot Set Test', // Changed from 'Select a Hot'
          style: TextStyle(
