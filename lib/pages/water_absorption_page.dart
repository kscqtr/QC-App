...
import 'water_absorption_strip_page.dart';
import 'water_absorption_tubular_page.dart';

class WaterAbsorptionPage extends StatefulWidget {
  const WaterAbsorptionPage({super.key});

  @override
  State<WaterAbsorptionPage> createState() => _WaterAbsorptionPageState();
}

class _WaterAbsorptionPageState extends State<WaterAbsorptionPage> {
  ...
  final List<Map<String, dynamic>> _carouselItemsData = [
    {
      'title': 'Strip',
      'imagePath': 'images/',
      'pageBuilder': () => const WaterAbsorptionStripPage(),
    },
    {
      'title': 'Tubular',
      'imagePath': 'images/',
      'pageBuilder': () => const WaterAbsorptionTubularPage(),
    },
  ];
