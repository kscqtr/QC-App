...
class ConstantKiPageState extends State<ConstantKiPage> {
  ...
  void _performCalculations() {
    ...
    setState(() {
      // Format results
      _calculatedResultVolumeResistivity = '${volumeResistivity.toStringAsFixed(3)} Ω.cm';
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                // Input Fields
                _buildInputRowNoDropbox(label: 'Cable length in water:', controller: _lengthController, selectedUnit: _selectedlengthUnit, onUnitChanged: (val) => _selectedlengthUnit = val!),
                _buildInputRow(label: 'Measured insulation resistance:', controller: _insulationResistanceController, selectedUnit: _selectedIRUnit, unitOptions: const ['MΩ', 'GΩ'], onUnitChanged: (val) => _selectedIRUnit = val!),
                _buildInputRowNoDropbox(label: 'Outer Diameter of Insulation:', controller: _outerDiameterController, selectedUnit: _selectedOuterDiameterUnit, onUnitChanged: (val) => _selectedOuterDiameterUnit = val!),
                _buildInputRowNoDropbox(label: 'Inner Diameter of Insulation:', controller: _innerDiameterController, selectedUnit: _selectedInnerDiameterUnit, onUnitChanged: (val) => _selectedInnerDiameterUnit = val!),
